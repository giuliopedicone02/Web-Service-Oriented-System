...
echo "Questo script elabora solo il primo dei file qui sopra e ignora gli altri<HR>";
...
echo "file type <b>vero</b> (da magic number del file temporaneo ricevuto): <code>$file_type</code><BR>";
